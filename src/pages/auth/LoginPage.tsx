...
const LoginPage = () => {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-nature-gradient bg-cover bg-center text-white flex-col p-12">
        <div>
        ...
        <div className="mt-12 mb-auto">
          ...
          <p className="text-lg text-white/90 mt-4">
            Our modern electronic health record system helps you provide the best care for your patients with powerful tools and an intuitive interface.
          </p>
          ...
          <div className="space-y-4 mt-6">
            <div className="flex items-start">
              ...
              <p className="ml-3 text-white/90">Comprehensive patient records and history</p>
            </div>
            <div className="flex items-start">
              <div className="mt-1 bg-white/20 p-1 rounded-full">
                <Check className="w-4 h-4" />
              </div>
              <p className="ml-3 text-white/90">Specialized examination tools</p>
            </div>
            <div className="flex items-start">
              <div className="mt-1 bg-white/20 p-1 rounded-full">
                <Check className="w-4 h-4" />
              </div>
              <p className="ml-3 text-white/90">MIPS-compliant documentation</p>
            </div>
            <div className="flex items-start">
              <div className="mt-1 bg-white/20 p-1 rounded-full">
                <Check className="w-4 h-4" />
              </div>
              <p className="ml-3 text-white/90">Seamless scheduling and patient management</p>
            </div>
          </div>
        </div>
